...
module.exports = function makeExchange(currency) {
			...
			if (Math.fround(currency / 50) >= 1) {
				if (Math.fround(currency / 50) == Math.floor(currency / 50)) {
				...
				if (Math.fround(currency / 25) == Math.floor(currency / 25)) {
				...
				if (Math.fround(currency / 10) == Math.floor(currency / 10)) {
				...
				if (Math.fround(currency / 5) == Math.floor(currency / 5)) {
				...
				if (Math.fround(currency / 1) == Math.floor(currency / 1)) {
					exchange.P = Math.floor(currency / 1);
					return exchange;			
				} else {
					exchange.P = Math.floor(currency / 1);
					currency = currency - 1 * exchange.P;
				}
			}
			return exchange;	
}
